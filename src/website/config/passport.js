...
module.exports = function(passport) {
	...
	if (config.twitter.consumer_key) {
		logger.ready('Enabling Twitter login Strategy');
	...
	if (config.facebook.clientID) {
		logger.ready('Enabling Facebook login Strategy');
		passport.use(new FacebookStrategy({
			clientID: config.facebook.clientID,
			clientSecret: config.facebook.clientSecret,
			callbackURL: `${require('../../config').domain}/auth/facebook/callback`,
	...
	if (config.google.clientID) {
		logger.ready('Enabling Google login Strategy');
