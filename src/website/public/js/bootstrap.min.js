...
!function(t, e) {
	...
	let o, a, l, h, c, u, f, d, _, g, p, m, v, E, T, y, C, I, A, b, D, S, w, N, O, k, P = function(t) {
			let e = !1;
			function n(e) {
				let n = this,
					s = !1;
			...
			var i = {
				...
				getSelectorFromElement: function(e) {
					let n, i = e.getAttribute('data-target');
					i && i !== '#' || (i = e.getAttribute('href') || ''),
					i.charAt(0) === '#' && (n = i,
					i = n = typeof t.escapeSelector == 'function' ? t.escapeSelector(n).substr(1) : n.replace(/(:|\.|\[|\]|,|=|@)/g, '\\$1'));
					try {
		...
		k), j = function(t) {
			const e = 'carousel',
				...
				C = function() {
					...
					C._addEventListeners = function() {
						...
						this._config.pause === 'hover' && (t(this._element).on(d.MOUSEENTER, function(t) {
							return e.pause(t);
					...
					C._slide = function(e, n) {
						let i, s, r, o = this, a = t(this._element).find(y.ACTIVE_ITEM)[0], l = this._getItemIndex(a), c = n || a && this._getItemByDirection(e, a), _ = this._getItemIndex(c), C = Boolean(this._interval);
						if (e === h ? (i = v,
						s = E,
						r = u) : (i = m,
						s = T,
						r = f),
						c && t(c).hasClass(g)) {this._isSliding = !1;} else if (!this._triggerSlideEvent(c, r).isDefaultPrevented() && a && c) {
							this._isSliding = !0,
							C && this.pause(),
					...
					o._jQueryInterface = function(e) {
						return this.each(function() {
							...
							if (i || (i = new o(this, s),
							t(this).data(n, i)),
							typeof e == 'number') {i.to(e);} else if (typeof l == 'string') {
				...
				m = function() {
					function i(e, n) {
						...
						for (let i = t(p.DATA_TOGGLE), s = 0; s < i.length; s++) {
							...
							o !== null && t(o).filter(e).length > 0 && (this._selector = o,
					...
					o.show = function() {
						let e, s, r = this;
						if (!this._isTransitioning && !t(this._element).hasClass(c) && (this._parent && (e = t.makeArray(t(this._parent).find(p.ACTIVES).filter('[data-parent="' + this._config.parent + '"]'))).length === 0 && (e = null),
					...
					o._getParent = function() {
						...
						typeof this._config.parent.jquery != 'undefined' && (n = this._config.parent[0])) : n = t(this._config.parent)[0];
			...
			const e = 'dropdown',
				...
				L = function() {
							...
							!i) {
								...
								!r.isDefaultPrevented()) {
									if (!this._inNavbar) {
										...
										this._config.boundary !== 'scrollParent' && t(e).addClass(v),
										this._popper = new n(o, this._menu, this._getPopperConfig());
									}
									'ontouchstart' in document.documentElement && t(e).closest(C).length === 0 && t('body').children().on('mouseover', null, t.noop),
									this._element.focus(),
					...
					a._jQueryInterface = function(e) {
						return this.each(function() {
							let n = t(this).data(i);
							if (n || (n = new a(this, typeof e == 'object' ? e : null),
							t(this).data(i, n)),
							typeof e == 'string') {
					...
					a._getParentFromElement = function(e) {
						let n, i = P.getSelectorFromElement(e);
						return i && (n = t(i)[0]),
						n || e.parentNode;
					}
					,
					a._dataApiKeydownHandler = function(e) {
						if ((/input|textarea/i.test(e.target.tagName) ? !(e.which === 32 || e.which !== 27 && (e.which !== 40 && e.which !== 38 || t(e.target).closest(y).length)) : h.test(e.which)) && (e.preventDefault(),
						e.stopPropagation(),
			...
			return t(document).on(h.CLICK_DATA_API, g.DATA_TOGGLE, function(e) {
				let i, s = this, o = P.getSelectorFromElement(this);
				o && (i = t(o)[0]);
				 ...
				 I = function() {
					...
					I.show = function() {
						...
						if (this.isWithContent() && this._isEnabled) {
							...
							const l = typeof this.config.placement == 'function' ? this.config.placement.call(this, r, this.element) : this.config.placement,
					...
					I.getTitle = function() {
						...
						return t || (t = typeof this.config.title == 'function' ? this.config.title.call(this.element) : this.config.title),
						t;
					}
					,
					...
					I._setListeners = function() {
						...
						this.config.trigger.split(' ').forEach(function(n) {
							if (n === 'click') {
								...
								const i = n === E ? e.constructor.Event.MOUSEENTER : e.constructor.Event.FOCUSIN,
					...
					I._fixTitle = function() {
						...
						(this.element.getAttribute('title') || t !== 'string') && (this.element.setAttribute('data-original-title', this.element.getAttribute('title') || ''),
					...
					I._fixTransition = function() {
						...
						e.getAttribute('x-placement') === null && (t(e).removeClass(g),
				 ...
				 g = function() {
					...
					return g.refresh = function() {
						...
						t.makeArray(t(this._selector)).map(function(e) {
							let n, r = P.getSelectorFromElement(e);
							if (r && (n = t(r)[0]),
							n) {
					...
					o._jQueryInterface = function(e) {
						return this.each(function() {
							let i = t(this).data(n);
							if (i || (i = new o(this, typeof e == 'object' && e),
							t(this).data(n, i)),
							typeof e == 'string') {
								if (typeof i[e] == 'undefined') {throw new TypeError('No method named "' + e + '"');}
								i[e]();
				 ...
				 v = function() {
					...
					return i.show = function() {
						...
						if (!(this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && t(this._element).hasClass(a) || t(this._element).hasClass(l))) {
							let n, i, s = t(this._element).closest(f)[0], o = P.getSelectorFromElement(this._element);
							if (s) {
								const h = s.nodeName === 'UL' ? _ : d;
								i = (i = t.makeArray(t(s).find(h)))[i.length - 1];
							}
							const c = t.Event(r.HIDE, {
									relatedTarget: this._element,
								}),
								u = t.Event(r.SHOW, {
									relatedTarget: i,
