...
!function(a, b) {
	...
	r.extend({
		...
		isPlainObject: function(a) {
			let b, c;
			return !(!a || k.call(a) !== '[object Object]') && (!(b = e(a)) || (c = l.call(b, 'constructor') && b.constructor,
		...
		makeArray: function(a, b) {
			const c = b || [];
			return a != null && (w(Object(a)) ? r.merge(c, typeof a == 'string' ? [a] : a) : h.call(c, a)),
			c;
		},
	...
	const x = function(a) {
		...
		function ga(a, b, d, e) {
			let f, h, j, k, l, o, r, s = b && b.ownerDocument, w = b ? b.nodeType : 9;
			if (d = d || [],
			typeof a != 'string' || !a || w !== 1 && w !== 9 && w !== 11) {return d;}
		...
		m = ga.setDocument = function(a) {
			...
			d.find.ID = function(a, b) {
				if (typeof b.getElementById != 'undefined' && p) {
					let c, d, e, f = b.getElementById(a);
					if (f) {
			...
			ja(function(a) {
				...
				a.querySelectorAll(':enabled').length !== 2 && q.push(':enabled', ':disabled'),
				o.appendChild(a).disabled = !0,
				a.querySelectorAll(':disabled').length !== 2 && q.push(':enabled', ':disabled'),
		...
		d = ga.selectors = {
			...
			preFilter: {
				...
				CHILD: function(a) {
					...
					a[1].slice(0, 3) === 'nth' ? (a[3] || ga.error(a[0]),
					a[4] = +(a[4] ? a[5] + (a[6] || 1) : 2 * (a[3] === 'even' || a[3] === 'odd')),
					a[5] = +(a[7] + a[8] || a[3] === 'odd')) : a[3] && ga.error(a[0]),
					a;
				},
				PSEUDO: function(a) {
					let b, c = !a[6] && a[2];
			...
			filter: {
				...
				ATTR: function(a, b, c) {
					return function(d) {
						let e = ga.attr(d, a);
						return e == null ? b === '!=' : !b || (e += '',
						b === '=' ? e === c : b === '!=' ? e !== c : b === '^=' ? c && e.indexOf(c) === 0 : b === '*=' ? c && e.indexOf(c) > -1 : b === '$=' ? c && e.slice(-c.length) === c : b === '~=' ? (' ' + e.replace(O, ' ') + ' ').indexOf(c) > -1 : b === '|=' && (e === c || e.slice(0, c.length + 1) === c + '-'));
					};
				},
							...
							if (q) {
								if (f) {
									while (p) {
										m = b;
										while (m = m[p]) {
											if (h ? m.nodeName.toLowerCase() === r : m.nodeType === 1) {return !1;}
										}
				...
				PSEUDO: function(a, b) {
					let c, e = d.pseudos[a] || d.setFilters[a.toLowerCase()] || ga.error('unsupported pseudo: ' + a);
		...
		function ta(a, b, c) {
			...
			return b.first ? function(b, c, e) {
				while (b = b[d]) {
					if (b.nodeType === 1 || g) {return a(b, c, e);}
				}
				return !1;
			}
				: function(b, c, i) {
		...
		function xa(a, b, c, d, e, f) {
			...
			e && !e[u] && (e = xa(e, f)),
			ia(function(f, g, h, i) {
				let j, k, l, m = [], n = [], o = g.length, p = f || va(b || '*', h.nodeType ? [h] : h, []), q = !a || !f && b ? p : wa(p, m, a, h, i), r = c ? e || (f ? a : o || d) ? [] : g : q;
				if (c && c(q, r, h, i),
				d) {
					j = wa(r, n),
					d(j, [], h, i),
		...
		i = ga.select = function(a, b, c, e) {
			let f, i, j, k, l, m = typeof a == 'function' && a, n = !e && g(a = m.selector || a);
			if (c = c || [],
			n.length === 1) {
				if (i = n[0] = n[0].slice(0),
				i.length > 2 && (j = i[0]).type === 'ID' && b.nodeType === 9 && p && d.relative[i[1].type]) {
	...
	r.filter = function(a, b, c) {
		const d = b[0];
		return c && (a = ':not(' + a + ')'),
		b.length === 1 && d.nodeType === 1 ? r.find.matchesSelector(d, a) ? [d] : [] : r.find.matches(a, r.grep(b, function(a) {
			return a.nodeType === 1;
		}));
	}
	,
	...
	r.fn.extend({
		...
		closest: function(a, b) {
			let c, d = 0, e = this.length, f = [], g = typeof a != 'string' && r(a);
			if (!A.test(a)) {
				for (; d < e; d++) {
	...
	r.extend({
							...
							return function() {
								var h = this,
									...
									j = function() {
										...
										if (!(b < f)) {
											if (a = d.apply(h, i),
											a === c.promise()) {throw new TypeError('Thenable self-resolution');}
		...
		when: function(a) {
			...
			g.state() === 'pending' || r.isFunction(e[c] && e[c].then))) {return g.then();}
	...
	d.readyState === 'complete' || d.readyState !== 'loading' && !d.documentElement.doScroll ? a.setTimeout(r.ready) : (d.addEventListener('DOMContentLoaded', S),
	...
	V.prototype = {
		...
		set: function(a, b, c) {
			...
			if (typeof b == 'string') {e[r.camelCase(b)] = c;} else {
		...
		access: function(a, b, c) {
			return void 0 === b || b && typeof b == 'string' && void 0 === c ? this.get(a, b) : (this.set(a, b, c),
			void 0 !== c ? c : b);
		},
		remove: function(a, b) {
			let c, d = a[this.expando];
			if (void 0 !== d) {
				if (void 0 !== b) {
	...
	r.fn.extend({
		data: function(a, b) {
			...
			if (void 0 === a) {
				...
				f.nodeType === 1 && !W.get(f, 'hasDataAttrs'))) {
					c = g.length;
					while (c--) {
						g[c] && (d = g[c].name,
						d.indexOf('data-') === 0 && (d = r.camelCase(d.slice(5)),
						_(f, d, e[d])));
					}
	...
	const aa = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source,
		...
		da = function(a, b) {
			return a = b || a,
			a.style.display === 'none' || a.style.display === '' && r.contains(a.ownerDocument, a) && r.css(a, 'display') === 'none';
		},
		ea = function(a, b, c, d) {
			let e, f, g = {};
			for (f in b) {
	...
	function fa(a, b, c, d) {
		let e, f = 1, g = 20, h = d ? function() {
			...
			i = h(), j = c && c[3] || (r.cssNumber[b] ? '' : 'px'), k = (r.cssNumber[b] || j !== 'px' && +i) && ba.exec(r.css(a, b));
		if (k && k[3] !== j) {
			j = j || k[3],
			c = c || [],
			k = +i || 1;
	...
	const ga = {};
	function ha(a) {
		let b, c = a.ownerDocument, d = a.nodeName, e = ga[d];
	...
	function ia(a, b) {
		for (var c, d, e = [], f = 0, g = a.length; f < g; f++) {
			...
			b ? (c === 'none' && (e[f] = W.get(d, 'display') || null,
			e[f] || (d.style.display = '')),
			d.style.display === '' && da(d) && (e[f] = ha(d))) : c !== 'none' && (e[f] = 'none',
			W.set(d, 'display', c)));
		}
	...
	function na(a, b) {
		let c;
		return c = typeof a.getElementsByTagName != 'undefined' ? a.getElementsByTagName(b || '*') : typeof a.querySelectorAll != 'undefined' ? a.querySelectorAll(b || '*') : [],
	...
	function qa(a, b, c, d, e) {
		...
		n = 0;
		while (f = m[n++]) {
			if (d && r.inArray(f, d) > -1) {e && e.push(f);} else if (j = r.contains(f.ownerDocument, f),
	...
	r.event = {
		...
		add: function(a, b, c, d, e) {
			let f, g, h, i, j, k, l, m, n, o, p, q = W.get(a);
			if (q) {
				c.handler && (f = c,
				c = f.handler,
				e = f.selector),
		...
		remove: function(a, b, c, d, e) {
			let f, g, h, i, j, k, l, m, n, o, p, q = W.hasData(a) && W.get(a);
			if (q && (i = q.events)) {
				b = (b || '').match(L) || [''],
				j = b.length;
				while (j--) {
		...
		dispatch: function(a) {
			let b = r.event.fix(a), c, d, e, f, g, h, i = new Array(arguments.length), j = (W.get(this, 'events') || {})[b.type] || [], k = r.event.special[b.type] || {};
			for (i[0] = b,
			c = 1; c < arguments.length; c++) {i[c] = arguments[c];}
		...
		handlers: function(a, b) {
			let c, d, e, f, g, h = [], i = b.delegateCount, j = a.target;
	...
	function Ha(a, b) {
		...
		if (b.nodeType === 1) {
			...
			j = f.events)) {
				...
				for (e in j) {
					for (c = 0,
					d = j[e].length; c < d; c++) {r.event.add(b, e, j[e][c]);}
				}
			}
	...
	function Ja(a, b, c, d) {
		b = g.apply([], b);
		let e, f, h, i, j, k, l = 0, m = a.length, n = m - 1, q = b[0], s = r.isFunction(q);
	...
	r.extend({
		...
		clone: function(a, b, c) {
			let d, e, f, g, h = a.cloneNode(!0), i = r.contains(a.ownerDocument, a);
			if (!(o.noCloneChecked || a.nodeType !== 1 && a.nodeType !== 11 || r.isXMLDoc(a))) {
				for (g = na(h),
				f = na(a),
				d = 0,
				e = f.length; d < e; d++) {Ia(f[d], g[d]);}
			}
			if (b) {
				if (c) {
					for (f = f || na(a),
	...
	r.fn.extend({
		...
		empty: function() {
			for (var a, b = 0; (a = this[b]) != null; b++) {
				a.nodeType === 1 && (r.cleanData(na(a, !1)),
				a.textContent = '');
			}
			return this;
		},
			...
			return T(this, function(a) {
				...
				if (typeof a == 'string' && !Aa.test(a) && !ma[(ka.exec(a) || ['', ''])[1].toLowerCase()]) {
					...
					try {
						for (; c < d; c++) {
							b = this[c] || {},
							b.nodeType === 1 && (r.cleanData(na(b, !1)),
							b.innerHTML = a);
						}
						b = 0;
					} catch (e) {}
	...
	function Za(a, b, c, d, e) {
		let f, g = 0;
		for (f = c === (d ? 'border' : 'content') ? 4 : b === 'width' ? 1 : 0; f < 4; f += 2) {
			c === 'margin' && (g += r.css(a, c + ca[f], !0, e)),
			d ? (c === 'content' && (g -= r.css(a, 'padding' + ca[f], !0, e)),
			c !== 'margin' && (g -= r.css(a, 'border' + ca[f] + 'Width', !0, e))) : (g += r.css(a, 'padding' + ca[f], !0, e),
			c !== 'padding' && (g += r.css(a, 'border' + ca[f] + 'Width', !0, e)));
		}
		return g;
	}
	function $a(a, b, c) {
		let d, e = Na(a), f = Oa(a, b, e), g = r.css(a, 'boxSizing', !1, e) === 'border-box';
	...
	r.extend({
		...
		style: function(a, b, c, d) {
			if (a && a.nodeType !== 3 && a.nodeType !== 8 && a.style) {
				let e, f, g, h = r.camelCase(b), i = Ra.test(b), j = a.style;
				return i || (b = Xa(h)),
				g = r.cssHooks[b] || r.cssHooks[h],
				void 0 === c ? g && 'get' in g && void 0 !== (e = g.get(a, !1, d)) ? e : j[b] : (f = typeof c,
				f === 'string' && (e = ba.exec(c)) && e[1] && (c = fa(a, b, e),
				f = 'number'),
				c != null && c === c && (f === 'number' && (c += e && e[3] || (r.cssNumber[h] ? '' : 'px')),
				o.clearCloneStyle || c !== '' || b.indexOf('background') !== 0 || (j[b] = 'inherit'),
				g && 'set' in g && void 0 === (c = g.set(a, c, d)) || (i ? j.setProperty(b, c) : j[b] = c)),
				void 0);
			}
		},
		css: function(a, b, c, d) {
			let e, f, g, h = r.camelCase(b), i = Ra.test(b);
			return i || (b = Xa(h)),
			g = r.cssHooks[b] || r.cssHooks[h],
	...
	r.each(['height', 'width'], function(a, b) {
		r.cssHooks[b] = {
			...
			set: function(a, c, d) {
				let e, f = d && Na(a), g = d && Za(a, b, d, r.css(a, 'boxSizing', !1, f) === 'border-box', f);
				return g && (e = ba.exec(c)) && (e[3] || 'px') !== 'px' && (a.style[b] = c,
				c = r.css(a, b)),
				Ya(a, c, g);
			},
		};
	...
	r.fn.extend({
		css: function(a, b) {
			return T(this, function(a, b, c) {
				...
				if (Array.isArray(b)) {
					for (d = Na(a),
					e = b.length; g < e; g++) {f[b[g]] = r.css(a, b[g], !1, d);}
					return f;
				}
	...
	r.extend({
		attr: function(a, b, c) {
			...
			if (f !== 3 && f !== 8 && f !== 2) {
				return typeof a.getAttribute == 'undefined' ? r.prop(a, b, c) : (f === 1 && r.isXMLDoc(a) || (e = r.attrHooks[b.toLowerCase()] || (r.expr.match.bool.test(b) ? _a : void 0)),
				void 0 !== c ? c === null ? void r.removeAttr(a, b) : e && 'set' in e && void 0 !== (d = e.set(a, c, b)) ? d : (a.setAttribute(b, c + ''),
				c) : e && 'get' in e && (d = e.get(a, b)) !== null ? d : (d = r.find.attr(a, b),
				d == null ? void 0 : d));
			}
		},
		attrHooks: {
	...
	r.each(r.expr.match.bool.source.match(/\w+/g), function(a, b) {
		const c = ab[b] || r.find.attr;
		ab[b] = function(a, b, d) {
			let e, f, g = b.toLowerCase();
			return d || (f = ab[g],
			ab[g] = e,
	...
	const bb = /^(?:input|select|textarea|button)$/i,
		cb = /^(?:a|area)$/i;
	r.fn.extend({
		prop: function(a, b) {
	...
	r.extend({
		prop: function(a, b, c) {
			let d, e, f = a.nodeType;
			if (f !== 3 && f !== 8 && f !== 2) {
				return f === 1 && r.isXMLDoc(a) || (b = r.propFix[b] || b,
				e = r.propHooks[b]),
	...
	r.fn.extend({
		...
		hasClass: function(a) {
			...
			b = ' ' + a + ' ';
			while (c = this[d++]) {
				if (c.nodeType === 1 && (' ' + db(eb(c)) + ' ').indexOf(b) > -1) {return !0;}
			}
			return !1;
		},
	});
			...
			let b, c, d, e = this[0];
			{
				if (arguments.length) {
					...
					this.each(function(c) {
						let e;
						this.nodeType === 1 && (e = d ? a.call(this, c, r(this).val()) : a,
						e == null ? e = '' : typeof e == 'number' ? e += '' : Array.isArray(e) && (e = r.map(e, function(a) {
							return a == null ? '' : a + '';
						})),
				...
				if (e) {
					...
					typeof c == 'string' ? c.replace(fb, '') : c == null ? '' : c);
				}
			}
		},
	}),
		...
		valHooks: {
			option: {
				get: function(a) {
					...
					return b != null ? b : db(r.text(a));
				},
			},
			select: {
				get: function(a) {
					let b, c, d, e = a.options, f = a.selectedIndex, g = a.type === 'select-one', h = g ? null : [], i = g ? f + 1 : e.length;
				...
				set: function(a, b) {
					let c, d, e = a.options, f = r.makeArray(b), g = e.length;
					while (g--) {
						d = e[g],
	...
	const gb = /^(?:focusinfocus|focusoutblur)$/;
	r.extend(r.event, {
		trigger: function(b, c, e, f) {
			let g, h, i, j, k, m, n, o = [e || d], p = l.call(b, 'type') ? b.type : b, q = l.call(b, 'namespace') ? b.namespace.split('.') : [];
			if (h = i = e = e || d,
			e.nodeType !== 3 && e.nodeType !== 8 && !gb.test(p + r.event.triggered) && (p.indexOf('.') > -1 && (q = p.split('.'),
			p = q.shift(),
			q.sort()),
			k = p.indexOf(':') < 0 && 'on' + p,
		...
		simulate: function(a, b, c) {
			const d = r.extend(new r.Event, c, {
				type: a,
				isSimulated: !0,
			});
	...
	function lb(a, b, c, d) {
		...
		} else if (c || r.type(b) !== 'object') {d(a, b);} else {
	...
	r.offset = {
		setOffset: function(a, b, c) {
			let d, e, f, g, h, i, j, k = r.css(a, 'position'), l = r(a), m = {};
	...
	r.fn.extend({
		...
		position: function() {
			if (this[0]) {
				...
				return r.css(c, 'position') === 'fixed' ? b = c.getBoundingClientRect() : (a = this.offsetParent(),
				b = this.offset(),
	...
	r.each({
		...
		r.fn[a] = function(d) {
			return T(this, function(a, d, e) {
				let f;
				return r.isWindow(a) ? f = a : a.nodeType === 9 && (f = a.defaultView),
		...
		r.each({
			...
			r.fn[d] = function(e, f) {
				...
				return T(this, function(b, c, e) {
					let f;
					return r.isWindow(b) ? d.indexOf('outer') === 0 ? b['inner' + a] : b.document.documentElement['client' + a] : b.nodeType === 9 ? (f = b.documentElement,
