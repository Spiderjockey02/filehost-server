...
(function(e, t) {
	...
	function r(e) {
		const o = e && e.offsetParent,
			i = o && o.nodeName;
		return i && i !== 'BODY' && i !== 'HTML' ? ['TD', 'TABLE'].indexOf(o.nodeName) !== -1 && t(o, 'position') === 'static' ? r(o) : o : e ? e.ownerDocument.documentElement : document.documentElement;
	}
	function p(e) {
		const t = e.nodeName;
	...
	function m(e, t, o, i) {
		return J(t['offset' + e], t['scroll' + e], o['client' + e], o['offset' + e], o['scroll' + e], ie() ? o['offset' + e] + i['margin' + (e === 'Height' ? 'Top' : 'Left')] + i['margin' + (e === 'Height' ? 'Bottom' : 'Right')] : 0);
	}
	function h() {
	...
	function u(e, o) {
		...
		return (i ? o.contains(d) : o === d && d.nodeName !== 'BODY') && (h = l(h, o)),
		h;
	}
	function b(e) {
	...
	function w(e) {
		const i = e.nodeName;
		return i === 'BODY' || i === 'HTML' ? !1 : t(e, 'position') === 'fixed' || w(o(e));
	}
	function y(e, t, i, r) {
		let p = {
				top: 0,
		...
		if (r === 'viewport') {p = b(s);} else {
			let a;
			r === 'scrollParent' ? (a = n(o(t)),
			a.nodeName === 'BODY' && (a = e.ownerDocument.documentElement)) : r === 'window' ? a = e.ownerDocument.documentElement : a = r;
			const l = u(a, s);
	...
	function Y(e, t) {
		Object.keys(t).forEach(function(o) {
			let i = '';
			['width', 'height', 'top', 'right', 'bottom', 'left'].indexOf(o) !== -1 && U(t[o]) && (i = 'px'),
			e.style[o] = t[o] + i;
		});
	}
	function j(e, t) {
	...
	function V(e, t, o, i) {
		...
		if (p === 'vh' || p === 'vw') {
			let a;
			return a = p === 'vh' ? J(document.documentElement.clientHeight, window.innerHeight || 0) : J(document.documentElement.clientWidth, window.innerWidth || 0),
			a / 100 * r;
		}
		return r;
	}
	...
	function G(e, t) {
		let o, i = t.offset, n = e.placement, r = e.offsets, p = r.popper, s = r.reference, d = n.split('-')[0];
		return o = U(+i) ? [+i, 0] : z(i, p, s, d),
		d === 'left' ? (p.top += o[0],
		p.left -= o[1]) : d === 'right' ? (p.top += o[0],
		p.left += o[1]) : d === 'top' ? (p.left += o[0],
		p.top -= o[1]) : d === 'bottom' && (p.left += o[0],
		p.top += o[1]),
		e.popper = p,
		e;
	}
	for (var _ = Math.min, X = Math.floor, J = Math.max, Q = typeof window != 'undefined' && typeof document != 'undefined', Z = ['Edge', 'Trident', 'Firefox'], $ = 0, ee = 0; ee < Z.length; ee += 1) {
		if (Q && navigator.userAgent.indexOf(Z[ee]) >= 0) {
			$ = 1;
			break;
		}
	}
	var i, te = Q && window.Promise, oe = te ? function(e) {
		...
		ie = function() {
			return void 0 == i && (i = navigator.appVersion.indexOf('MSIE 10') !== -1),
			i;
		}, ne = function(e, t) {
	...
	return fe.Utils = (typeof window == 'undefined' ? global : window).PopperUtils,
	fe.placements = de,
	fe.Defaults = {
		placement: 'bottom',
		eventsEnabled: !0,
		...
		modifiers: {
						...
						s = {
							...
							secondary: function(e) {
								let o = e === 'right' ? 'left' : 'top',
									n = p[o];
								return p[e] > i[e] && !t.escapeWithReference && (n = _(p[o], i[e] - (e === 'right' ? p.width : p.height))),
								pe({}, o, n);
							},
						};
			...
			flip: {
				...
				fn: function(e, t) {
					...
					let o = y(e.instance.popper, e.instance.reference, t.padding, t.boundariesElement),
					...
					return p.forEach(function(s, d) {
						...
						const a = e.offsets.popper,
							...
							w = ['top', 'bottom'].indexOf(i) !== -1,
							 y = !!t.flipVariations && (w && r === 'start' && h || w && r === 'end' && c || !w && r === 'start' && g || !w && r === 'end' && u);
						(m || b || y) && (e.flipped = !0,
						(m || b) && (i = p[d + 1]),
						y && (r = K(r)),
						e.placement = i + (r ? '-' + r : ''),
			...
			computeStyle: {
				...
				fn: function(e, t) {
					...
					let s, d, a = void 0 === p ? t.gpuAcceleration : p, l = r(e.instance.popper), f = g(l), m = {
							position: n.position,
						}, h = {
							left: X(n.left),
							top: X(n.top),
							bottom: X(n.bottom),
							right: X(n.right),
						}, c = o === 'bottom' ? 'top' : 'bottom', u = i === 'right' ? 'left' : 'right', b = W('transform');
					if (d = c == 'bottom' ? -f.height + h.bottom : h.top,
