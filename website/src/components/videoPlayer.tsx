...
export default function DisplayFile({ files }: Props) {
	...
	return (
		<>
			<link rel="stylesheet" href="http://192.168.0.14:3000/videoPlayer.css" />
			<div className="video-container" id="video-container">
				...
				<div id="settings-tab" className="video-controls hidden">
					<div className="form-group">
						...
						<input type="range" className="form-control-range bg-dark" id="formControlRange" value="1" max="2" step="0.50" />
					</div>
				</div>
				<div className="video-controls hidden" id="video-controls">
					<div className="video-progress">
						<div className="progress-bar" id="seek-bar"></div>
						<input className="seek" id="seek" value="0" min="0" type="range" step="0.01" />
					...
					<div className="bottom-controls">
						<div className="left-controls">
							...
							<div className="volume-controls" id="volume-controls">
								...
								<input className="volume" id="volume" value="1" data-mute="0.5" type="range" max="1" min="0" step="0.05" />
							</div>
							<div className="time">
